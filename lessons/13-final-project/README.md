...
## Starter File
Open `templates/` and choose one game idea folder. Each folder includes a planning `README.md` and an incomplete `*_starter.ino` scaffold that still needs real code from you.
...
2. Write your required features before filling in code.
