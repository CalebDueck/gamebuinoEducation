...
This lesson teaches you how the game can remember changing values like score and lives.
...
- `int` means a whole-number variable that can store values like `0`, `1`, `10`, or `-3`.
