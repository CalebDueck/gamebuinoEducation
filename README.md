...
Teachers should read `SETUP_GAMEBUINO_CLASSIC.md` before class. Students start with `lessons/00-setup/README.md` and `projects/00_welcome_badge/welcome_badge.ino`.
